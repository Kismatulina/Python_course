...
# for i in range(5): # потом туда направились 1,2 и т.д (i будет принимать значение от 0 до 4)
...
# list_1 = [12, 7, -1, 21, 0]
# print(list_1.pop()) # 0 и pop также и возвращает нулевой элемент
...
# на уроке дальше:
# v = [1, 8, 9] # у нас есть список(выведит в[] лист) и хотим преобразовать его в кортеж
# print(v)
# print(type(v))
...
# print(dictionary['left']) # ← будет выводится по ключу left , не понятно а где создание ключа? d['q'] = 'gwerty' ?
...
# for item in dictionary: # for (k,v) in dictionary.items(): как фор взаимодействует с нашим словарем?:
    ...
    # print('{}: {}'.format(item, dictionary[item])) # если к словарю обращаться то сначала к ключу('{}: {}'.format(item,) и 2е к значению
# up: ↑
# left: ←
# down: ↓
# right: →
...
# print(colors) # {'red', 'green', 'blue'}  добавляет тольк уникальное значение, поэтому тоже самое
...
# q = set()  # при помощи set() можно создавать множествщ
